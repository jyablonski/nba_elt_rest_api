...
def standings_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/standings.json"
    )
...
def game_types_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/game_types.json"
    )
...
def injuries_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/injuries.json"
    )
...
def injuries_team_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/injuries_team.json"
    )
...
def reddit_comments_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/reddit_comments.json"
    )
...
def scorers_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/scorers.json"
    )
...
def team_ratings_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/team_ratings.json"
    )
...
def team_ratings_team_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/team_ratings_team.json"
    )
...
def twitter_comments_fixture():
    ...
    fname = os.path.join(
        os.path.dirname(__file__), "fixtures/twitter_comments.json"
    )
